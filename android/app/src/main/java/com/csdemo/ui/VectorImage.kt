...
//    }
    ...
    //param[1] = width (String)
    //param[2] = height (String)
    //param[3] = tint color (String)
    ...
    fun setParams(props: ReadableArray) {
        ...
        if(props.getString(3).isNotEmpty()) this.setColorFilter(Color.parseColor(props.getString(3)), PorterDuff.Mode.SRC_IN)
        ...
        if(this.layoutParams != null){
            ...
            surfaceParams.width = props.getString(2).toInt()
